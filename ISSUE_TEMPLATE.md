<!-- 
   ...
   If you're new to FastCSharp.Mapper, please ask a question on StackOverflow first and come back here if the people there consider it a bug.
   If you've just upgraded, please read the corresponding upgrade guide first. Check https://docs.FastCSharp.Mapper.org/en/latest.
   Try the [MyGet](https://docs.FastCSharp.Mapper.org/en/latest/The-MyGet-build.html) build.
