...
Occasionally, you might need to perform custom logic before or after a map occurs. These should be a rarity, as it's more obvious to do this work outside of FastCSharp.Mapper. You can create global before/after map actions:
...
public class Startup
{
    ...
    {
        services.AddFastCSharp.Mapper(typeof(Startup).Assembly);
    }
    //..
}
```