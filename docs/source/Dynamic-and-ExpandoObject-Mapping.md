...
FastCSharp.Mapper can map to/from dynamic objects without any explicit configuration:
...
Similarly you can map straight from `Dictionary<string, object>` to objects, FastCSharp.Mapper will line up the keys with property names.
