...
You will notice that because the mapped object is a OnlineOrder, FastCSharp.Mapper has seen you have a more specific mapping for OnlineOrder than OrderDto, and automatically chosen that.
...
Overall this feature should make using FastCSharp.Mapper with classes that leverage inheritance feel more natural.
